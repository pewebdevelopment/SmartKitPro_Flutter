...
class ColorsRes {
  ...
  static const MaterialColor appcolor_material = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFFFE724C),
      100: Color(0xFFFE724C),
      200: Color(0xFFFE724C),
      300: Color(0xFFFE724C),
      400: Color(0xFFFE724C),
      500: Color(0xFFFE724C),
      600: Color(0xFFFE724C),
      700: Color(0xFFFE724C),
      800: Color(0xFFFE724C),
      900: Color(0xFFFE724C),
    },
  );
}
