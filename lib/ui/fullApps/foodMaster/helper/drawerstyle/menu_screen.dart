// ignore_for_file: prefer_function_declarations_over_variables, use_key_in_widget_constructors, overridden_fields, annotate_overrides
...
import 'package:smartkit_pro/ui/fullApps/foodMaster/helper/drawerstyle/drawer_scaffold.dart';
...
class SideDrawer<T> extends StatefulWidget {
  ...
  double maxSlideAmount(context) => drawerWidth;
...
class _SideDrawerState extends State<SideDrawer> with TickerProviderStateMixin {
  ...
  Widget createDrawer(MenuController menuController) {
    ...
    if (widget.headerView != null) {
      widgets.add(SizedBox(width: double.infinity, child: widget.headerView));
    }
                ...
                children: [
                  Container(
                    ...
                    child: Card(
                      ...
                      child: /*Image.asset(
                        "assets/images/fullApps/foodMaster/background_image.png",
                        fit: BoxFit.fill,
                        alignment: Alignment.centerRight,
