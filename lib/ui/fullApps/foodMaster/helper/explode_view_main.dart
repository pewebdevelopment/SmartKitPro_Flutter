...
class ExplodeViewMain extends StatelessWidget {
...
class _ExplodeViewState extends State<ExplodeViewBody>
  ...
  explodeImage() {
    ...
    double imageCenterPositionX = MediaQuery.of(context).size.width / 2;
    double imageCenterPositionY = MediaQuery.of(context).size.height / 2;
      ...
      for (int i = 0; i < noOfParticles; i++) {
        ...
        if (i < 21) {
          particles.add(Particle(
              ...
              offsetX:
                  (imageCenterPositionX - imagePositionOffsetX + (i * 0.7)) *
                      0.1,
              offsetY:
                  (imageCenterPositionY - (imagePositionOffsetY - 60)) * 0.1,
          ...
          particles.add(Particle(
              ...
              //colors: colors[i].withOpacity(1.0),
              offsetX:
                  (imageCenterPositionX - imagePositionOffsetX + (i * 0.5)) *
                      0.1,
              offsetY:
                  (imageCenterPositionY - (imagePositionOffsetY - 52)) * 0.1,
              newOffsetX: imagePositionOffsetX + (i * 0.7),
          ...
          particles.add(Particle(
              ...
              colors: color.withOpacity(1.0),
              offsetX:
                  (imageCenterPositionX - imagePositionOffsetX + (i * 0.9)) *
                      0.1,
              offsetY:
                  (imageCenterPositionY - (imagePositionOffsetY - 68)) * 0.1,
              newOffsetX: imagePositionOffsetX + (i * 0.7),
  ...
  @override
  void dispose() {
    if (imageAnimationController != null) imageAnimationController!.dispose();
    controller.dispose();
    super.dispose();
  }
}
...
class Particle extends _ExplodeViewState {
  ...
  late Animation translateXAnimation, negatetranslateXAnimation;
  late Animation translateYAnimation, negatetranslateYAnimation;
  ...
  Particle(
    ...
    lastXOffset = random.nextDouble() * 100;
    lastYOffset = random.nextDouble() * 100;
          ...
          if (id % 4 == 0) {
            return Transform.translate(
                ...
                child: FadeTransition(
                  opacity: fadingAnimation as Animation<double>,
                  child: Container(
