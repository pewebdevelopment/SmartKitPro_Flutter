  ...
  Widget build(BuildContext context) {
    ...
    return CompositedTransformTarget(
      ...
      child: Container(
        width: style.width,
        height: style.height,
        decoration: DesignConfig.outerDecorationService(15, salonbgcolor),
        child: TextButton(
            ...
            children: [
              ...
              Expanded(
                  child: widget.selectedvalue == null ||
                          widget.selectedvalue!.trim().isEmpty
                      ? widget.child
                      : Text(
                  ...
                  child: widget.icon ??
                      IconShadowWidget(
                        Icon(Icons.arrow_drop_down,
                            color: salonbgcolor, size: 36),
                        shadowColor: salondarkshadow,
                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: widget.selectedvalue ==
                                              item.value.value
                                      ...
                                      margin: EdgeInsets.only(
                                        left: 8,
                                        right: 8,
                                        top: widget.selectedvalue ==
                                                item.value.value
                                            ? 5
                                            : 5,
                                      ),
                                      padding: EdgeInsets.symmetric(
                                          vertical: widget.selectedvalue ==
                                                  item.value.value
                                              ? 5
                                              : 0),
                                      child: item.value,
